            ...
            <div class="tab-content">
              <div class="active tab-pane" id="activity">
                    ...
                    <div class="col-sm-10">
                      <ul id="imageList">
                        ...
                        <div class="input-group">
                          ...
                          <input id="sub-thumb_3" class="form-control" type="text" name="sub_image[]" value="{{ old('sub_image[3]') }}">
                        </div>
                        </div>
                        <div class="col-sm-5">
                        <div class="input-group">
                          ...
                          <input id="sub-thumb_4" class="form-control" type="text" name="sub_image[]" value="{{ old('sub_image[4]') }}">
                        </div>
                        </div>
                        </li>
                        <li class="row">
                        ...
                        <div class="input-group">
                          ...
                          <input id="sub-thumb_5" class="form-control" type="text" name="sub_image[]" value="{{ old('sub_image[5]') }}">
                        </div>
                        </div>
                        <div class="col-sm-5">
                        <div class="input-group">
                          ...
                          <input id="sub-thumb_6" class="form-control" type="text" name="sub_image[]" value="{{ old('sub_image[6]') }}">
                        </div>
                        </div>
                        </li>
                      </ul>
                  ...
                  <div class="form-group @if(!empty($errors->first('school_name'))) has-error @endif">
                    ...
                    <div class="col-sm-10">
                      {!! Form::text('school_name', old('school_name'), ['class' => 'form-control' , 'id' => 'inputName' , 'placeholder' => '教室名']) !!}
                  ...
                  <div class="form-group @if(!empty($errors->first('number'))) has-error @endif">
                    ...
                    <div class="col-sm-6">
                      {!! Form::text('number', old('number'), ['class' => 'form-control' , 'id' => 'inputNumber' , 'placeholder' => '電話番号']) !!}
                  ...
                  <div class="form-group @if(!empty($errors->first('direct_number'))) has-error @endif">
                    ...
                    <div class="col-sm-6">
                      {!! Form::text('direct_number', old('direct_number'), ['class' => 'form-control' , 'id' => 'inputDirect' , 'placeholder' => 'スクール直通電話番号']) !!}
                  ...
                  <div class="form-group @if(!empty($errors->first('email'))) has-error @endif">
                    ...
                    <div class="col-sm-6">
                      {!! Form::email('email', old('email'), ['class' => 'form-control' , 'id' => 'inputEmail' , 'placeholder' => 'Email']) !!}
                  ...
                  <div class="form-group @if(!empty($errors->first('zip'))) has-error @endif">
                    ...
                    <div class="col-xs-3">
                      {!! Form::text('zip', old('zip'), ['class' => 'form-control' , 'id' => 'inputZip' , 'placeholder' => '郵便番号' , 'maxlength' => '7' , 'onKeyUp' => 'AjaxZip3.zip2addr(this,"","pref","addr01");']) !!}
                  ...
                  <div class="form-group @if(!empty($errors->first('pref'))) has-error @endif">
                    ...
                    <div class="col-sm-6">
                      {!! Form::text('pref', old('pref'), ['class' => 'form-control' , 'id' => 'inputName' , 'placeholder' => '東京都']) !!}
                  ...
                  <div class="form-group @if(!empty($errors->first('addr01')) or !empty($errors->first('addr02'))) has-error @endif">
                    ...
                    <div class="col-sm-10">
                      {!! Form::text('addr01', old('addr01'), ['class' => 'form-control' , 'id' => 'inputName' , 'placeholder' => '足立区千住']) !!}<br />
                      @if(!empty($errors->first('addr01')))<span class="help-block">{{$errors->first('addr01')}}</span>@endif
                      {!! Form::text('addr02', old('addr02'), ['class' => 'form-control' , 'id' => 'inputName' , 'placeholder' => '1-4-1']) !!}<br />
                      @if(!empty($errors->first('addr02')))<span class="help-block">{{$errors->first('addr02')}}</span>@endif
                      {!! Form::text('addr03', old('addr03'), ['class' => 'form-control' , 'id' => 'inputName' , 'placeholder' => '東京芸術センター11F']) !!}
                    </div>
                  </div>
                  ...
                  <div class="form-group @if(!empty($errors->first('lat')) or !empty($errors->first('lng'))) has-error @endif">
                    ...
                    <div class="col-sm-3">
                      {!! Form::text('lat', old('lat'), ['class' => 'form-control' , 'id' => 'inputName' , 'placeholder' => '35.746978']) !!}
                      @if(!empty($errors->first('lat')))<span class="help-block">{{$errors->first('lat')}}</span>@endif
                    </div>
                    <div class="col-sm-3">
                      {!! Form::text('lng', old('lng'), ['class' => 'form-control' , 'id' => 'inputName' , 'placeholder' => '139.800504']) !!}
                      @if(!empty($errors->first('lng')))<span class="help-block">{{$errors->first('lng')}}</span>@endif
                    </div>
                  </div>
                  <!-- #192  スクール営業時間を管理画面から登録できるように -->
                  <div class="form-group @if(!empty($errors->first('business_start')) or !empty($errors->first('business_end'))) has-error @endif">
                    ...
                    <div class="col-sm-2">
                      {!! Form::text('business_start', old('business_start'), ['class' => 'form-control' , 'placeholder' => '10:00']) !!}
                    ...
                    <div class="col-sm-2">
                      {!! Form::text('business_end', old('business_end'), ['class' => 'form-control' , 'placeholder' => '20:00']) !!}
              ...
              <div class="tab-pane" id="settings">
                <form class="form-horizontal">
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      {!! Form::text('access', old('access'), ['class' => 'form-control' , 'id' => 'inputAccess' , 'placeholder' => '交通アクセス']) !!}
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      {!! Form::text('trafic', old('trafic'), ['class' => 'form-control' , 'id' => 'inputTrafic' , 'placeholder' => 'アクセス情報詳細']) !!}
                      @if(!empty($errors->first('trafic')))<span class="help-block">{{$errors->first('trafic')}}</span>@endif
                    </div>
                  </div>
                  <div class="form-group">
